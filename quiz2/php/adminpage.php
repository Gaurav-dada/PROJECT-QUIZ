...
<body>
  ...
  <aside class="sidebar">
     <div id="dashboard">
        ...
        <a href="../php/adminpage.php">DashBoard</a>
    </div>
    ...
    <div id="create">
        ...
        <a href="../php/category.php " target="_blank">Manage Quiz</a>
    </div>
    ...
    <div id="manage">
        ...
        <a href="../php/usermanage.php">User Management</a>
    </div>
    ...
    <div id="result">
        ...
        <a href="../php/adminresultanalysis.php">Result & Analysis</a>
    </div>
